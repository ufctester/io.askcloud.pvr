...
SET GROOVY_SCRIPT=C:\gitbash\opt\eclipse\workspace\io.askcloud.pvr\scripts\filebot\find-series-episodes-missing.groovy
SET SERIES_MISSING_EPISODES_OUTPUT=C:\gitbash\opt\eclipse\workspace\io.askcloud.pvr\queue\series-episodes-missing.txt
SET SERIES_MISSING_EPISODES_OUTPUT_FILTER=C:\gitbash\opt\eclipse\workspace\io.askcloud.pvr\scripts\filebot\find-series-episodes-missing-excludes.txt
