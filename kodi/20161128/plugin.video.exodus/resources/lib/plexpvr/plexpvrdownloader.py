...
import re,json,urllib,urllib2,urlparse,xbmc,xbmcgui,xbmcplugin,xbmcvfs,os,inspect,shutil,csv
...
if __name__ == '__main__':
    ...
    if 'plexpvrdownloader.py' in sys.argv[0]:
        ...
        xbmc.log('    image: %s' % (sys.argv[4]), xbmc.LOGNOTICE)
        xbmc.log('    headers: %s' % (sys.argv[5]), xbmc.LOGNOTICE)
